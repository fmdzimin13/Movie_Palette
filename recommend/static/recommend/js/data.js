...
const qnaList = [
  {
    q: '1. 여행을 간다면 가장 가고 싶은 여행지는 어디인가요?',
    a: [
  ...
  {
    q: '2. 당신이 요즘 즐겨듣는 음악은 무엇인가요?',
    a: [
      { answer: '발라드', type: ['Romance']},
      { answer: '트로트', type: ['Family']},
      { answer: '힙합', type: ['Action', 'History']},
  ...
  {
    q: '5. 당신의 눈 앞에 램프 속 지니가 나타났다. 원하는 능력을 하나 준다고 했을 때 어떤 것을 고를 것인가?',
    a: [
  ...
  {
    q: '6. 해리포터 시리즈의 호그와트에서 가장 들어보고 싶은 수업은?',
    a: [
  ...
  {
    q: '9. 다음 중 무조건 하나를 선택해야한다면 무엇을 선택하겠습니까?',
    a: [
      { answer: '하루 10시간 알고리즘 문제 풀기 + 단, 윤소영 교수님 없음', type: ['Romance', 'History']},
      { answer: '시간대별로 건강설문하기', type: ['Family']},
